...
scenario="PictureBADE_EEGshortB";
pcl_file = "PictureBADE_EEGshortB.pcl";
...
trial{
	...
	picture {text {caption = "debug your pcl file"; } img_txt ;	x=$text_x ; y=$text_y;
				bitmap { filename = "banana split_img3.png"; preload = true; height = 225; scale_factor = scale_to_height;} img ; x=$img_x;y=$img_y;
